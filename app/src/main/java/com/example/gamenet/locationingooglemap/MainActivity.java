...
public class MainActivity extends AppCompatActivity implements LocationListener, GoogleMap.OnInfoWindowClickListener {
    ...
    private void showDetail() {
        ...
        alertDialog.setContentView(R.layout.detail_info);

        tv1 = (TextView) alertDialog.findViewById(R.id.tv_lat);
        tv2 = (TextView) alertDialog.findViewById(R.id.tv_lng);
    ...
    public void onInfoWindowClick(Marker marker) {
        ...
        showDetail();
        tv1.setText("Latitude:" + latLng.latitude);
        tv2.setText("Longitude:"+ latLng.longitude);
        alertDialog.show();
